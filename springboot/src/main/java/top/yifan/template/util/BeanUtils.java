...
import top.yifan.template.exception.BeanUtilsException;
...
public final class BeanUtils {
     ...
     * 将list封装成map，以指定属性作为键，需要注意的是如果属性值有重复会被覆盖
     * <pre>
    ...
    /**
     * 根据列表里面的属性聚合
     * 与mapByKey的区别在于如果属性值有重复也不会被覆盖
     *
     * <pre>
     * List<ShopDTO> shopList = shopService.queryShops();
     * Map<Integer, List<ShopDTO>> city2Shops = BeanUtils.aggByKeyToList("cityId", shopList);
     * </pre>
     */
    @SuppressWarnings("unchecked")
